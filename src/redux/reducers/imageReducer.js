import { CREATE_IMAGE, CREATE_IMAGE_ERROR, DELETE_IMAGE, DELETE_IMAGE_ERROR, FETCH_IMAGES, FETCH_IMAGES_ERROR, FIND_IMAGES, FIND_IMAGES_ERROR, LIKE_IMAGE, LIKE_IMAGE_ERROR, SET_IMAGE_TO_EDIT, UPDATE_IMAGE, UPDATE_IMAGE_ERROR } from './../types'
const initState = {
    data: [],
    searchedImages:null,
    error: null,
